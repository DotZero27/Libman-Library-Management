            ...
            {error ? <div className="flex text-5xl font-bold justify-center items-center w-full">
                ...
                <>
                    <div className='sticky top-0 w-full  sm:w-[30%] sm:mx-4'>
                        ...
                        <div className={`${!openFilters ? 'hidden' : 'flex flex-col justify-between'} h-[500px] border bg-slate-800 border-white p-4 rounded-md sm:flex flex-col justify-between sm:mt-10 `}>
                            <div>
                        ...
                        >
                            {filteredData?.length > 0 &&
                                filteredData.map((book) => (
                                    <div key={book.id} className="border border-white rounded-md p-2 gap-2 flex flex-col sm:flex-row mb-4">
                                        {/* Book content */}
                                        <div>
